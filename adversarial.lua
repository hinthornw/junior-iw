...
cmd:option('-out', '', 'Subfolder output')
...
local lbfgsb_max_iter = 200 -- OLD: 150
...
if not failed then
	print("Adversarial Image Search Succesful. Saving.")
	if mnist then
		-- save_name = outf .. outFolder .. '/' .. save_name
		image.save(outf .. outFolder .. '/' .. save_name .. '_adversarial_' .. label[original_target] .. '_' .. label[adversarial_target] .. '_' .. seed .. '.png', disturbed/255)
		image.save(outf .. outFolder .. '/' .. save_name .. '_distortion_' .. label[original_target] .. '_'   .. label[adversarial_target] .. '_' .. seed .. '.png', originalDisturbanceLayer/255)
		image.save(outf .. outFolder .. '/' .. save_name .. '_original_'  .. label[original_target] .. '_'   .. label[adversarial_target] .. '_' .. seed .. '.png', original/255)
	else
		image.save(save_name .. '_adversarial_' .. label[original_target] .. '_' .. label[adversarial_target] .. '_' .. seed .. '.png', disturbed/255)
		image.save(save_name .. '_distortion_' .. label[original_target] .. '_'   .. label[adversarial_target] .. '_' .. seed .. '.png', originalDisturbanceLayer/255)
		image.save(save_name .. '_original_'  .. label[original_target] .. '_'   .. label[adversarial_target] .. '_' .. seed .. '.png', original/255)
	end
end
io.write("truncating save name\n")
print(save_name)
print("")
if mnist then
	save_name = outf .. outFolder
else
